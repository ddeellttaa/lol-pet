...
- [x] Reads as League of Legends Neeko, not a generic fairy, elf, dryad, or lizard.
- [x] Hair fins, pink flower, amber eyes, green limbs, leaf tunic, and curled tail stay readable.
- [x] Q row reads as Blooming Burst without text or detached icons.
- [x] W row reads as Shapesplitter without a separate full clone sprite.
- [x] E row reads as Tangle-Barbs without long detached vine lines.
- [x] R row reads as Pop Blossom without huge detached flower explosions.
