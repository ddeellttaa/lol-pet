Create a single horizontal sprite strip for the Codex app digital pet `syndra` in the state `jumping`.
...
Animation action: Syndra E cue, Scatter the Weak recoil hop. Show a sharp upward recoil pose while the close dark sphere is nudged forward against the body silhouette, then settle.


State-specific requirements:
- The row must read as Scatter the Weak in pet scale through pose, vertical body position, and one close sphere pushed forward only.
- Show the jump through pose and vertical body position only: anticipation, lift, airborne peak with forward-nudged sphere, descent, settle.
- Do not draw ground shadows, contact shadows, drop shadows, oval shadows, landing marks, dust, smears, bounce pads, or motion marks under the pet.
- Do not draw wide cone blasts, stun symbols, speed lines, detached shockwaves, enemy targets, text, skill icons, or loose projectiles.
