Create a single horizontal sprite strip for the Codex app digital pet `lol-aphelios` in the state `jumping`.
...
Animation action: Aphelios E cue, Weapon Queue readiness hop. Show anticipation, lift, peak, descent, settle while a tiny next-weapon crescent stays tucked behind the shoulder.
...
- The row must read as weapon readiness, not a HUD: the next-weapon cue is a small attached crescent silhouette behind the shoulder.
- Do not draw weapon queue UI, numbered ammo, floating weapon order, detached moon icons, or explanatory symbols.
