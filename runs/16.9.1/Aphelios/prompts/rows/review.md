Create a single horizontal sprite strip for the Codex app digital pet `lol-aphelios` in the state `review`.
...
Animation action: Aphelios R cue, Moonlight Vigil focus loop. Show a focused kneeling or aiming stance with one short hard-edged moonlight glow attached to the crescent weapon.


State-specific requirements:
- Show review through lean, blink, narrowed eyes, head tilt, or paw position.
- Do not add magnifying glasses, papers, code, UI, punctuation, symbols, or other new props unless they already exist in the base pet identity.
- The row must read as Moonlight Vigil in pet scale through a focused aim pose and a small attached weapon glow.
- Do not draw a giant lunar beam, explosion, enemy champion, full moon backdrop, detached aura, rain of attacks, skill icon, text, or scenery.
